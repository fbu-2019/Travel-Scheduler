...
//@property (strong, nonatomic) UIImageView *secondStarImageView;
//@property (strong, nonatomic) UIImageView *thirdStarImageView;
//@property (strong, nonatomic) UIImageView *fourthStarImageView;
//@property (strong, nonatomic) UIImageView *fifthStarImageView;
